  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 bg-blue-500 relative cursor-pointer"></li>
        <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 bg-green-500 relative cursor-pointer"></li>

        <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 bg-red-500 relative cursor-not-allowed">
      ...
      <ul className="flex items-center gap-3">
        ...
        <li className="ring-1 ring-lama bg-pink-200 text-lama rounded-md py-1 px-4 text-sm cursor-not-allowed">
          Large
        </li>
      </ul>
    </div>
