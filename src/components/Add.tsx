      ...
      <div className='flex justify-between'>
        <div className="flex items-center gap-4">
          ...
          <div className="bg-gray-100 py-2 px-4 rounded-3xl flex items-center justify-between w-32">
            <button onClick={() => handleQuantity("d")} className="cursor-pointer text-xl disabled:cursor-not-allowed disabled:opacity-20">
              -
            </button>
            {quantity}
            <button onClick={() => handleQuantity("i")} className="cursor-pointer text-xl disabled:cursor-not-allowed disabled:opacity-20">
              +
            </button>
          </div>
          {/* TEXT */}
